    ...
    <>
      ...
      {isOpen && (
        <HeaderBurgerContent>
          ...
          <LandingHeaderBlurredCircle />
          <HeaderBurgerContentNavigation>
            <HeaderBurgerContentNavigationLink to={"/"} onClick={() => setIsOpen(false)}>Возможности</HeaderBurgerContentNavigationLink>
            <HeaderBurgerContentNavigationLink to={"/"} onClick={() => setIsOpen(false)}>Как это работает</HeaderBurgerContentNavigationLink>
            <HeaderBurgerContentNavigationLink to={"/"} onClick={() => setIsOpen(false)}>Стоимость</HeaderBurgerContentNavigationLink>
            <HeaderBurgerContentNavigationLink to={"/"} onClick={() => setIsOpen(false)}>Контакты</HeaderBurgerContentNavigationLink>
          </HeaderBurgerContentNavigation>
          <HeaderBurgerContentIcons>
            <HeaderBurgerContentIconBlock to={"/"} target="_blank" rel="noopener noreferrer">
              <HeaderBurgerContentIcon width="20" height="20" viewBox="0 0 20 20"><g clip-path="url(#a)">
