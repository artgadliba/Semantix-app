import { LoadingIconMobile } from "components/Mixins/Mixins";

const LoadingIconMobileSVG = () => {
    return (
        <LoadingIconMobile viewBox="0 0 48 66" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default LoadingIconMobileSVG;