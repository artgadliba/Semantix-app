...
const LandingFooter: FC = () => {
    ...
    return (
        <LandingFooterBlock itemScope itemType="http://schema.org/Organization">
            ...
            <LandingFooterBody>
                <LandingFooterStampWrapper>
                    <LandingFooterStamp>Москва - 2023</LandingFooterStamp>
                    <LandingFooterStamp className="brand_name" itemProp="name">
                        Semantix
                    </LandingFooterStamp>
                </LandingFooterStampWrapper>
                <LandingFooterDocumentsNavigation>
                    <LandingFooterDocumentLink to="/">Оферта</LandingFooterDocumentLink>
                    <LandingFooterDocumentLink to="/">Политика конфиденциальности</LandingFooterDocumentLink>
                </LandingFooterDocumentsNavigation>
                <LandingFooterContactsBlock>
                    <LandingFooterContactTelegramBlock to="https://t.me/semantix_one">
                    <LandingFooterTelegramIcon width="20" height="20" viewBox="0 0 20 20"><g clipPath="url(#a)">
                    ...
                    <LandingFooterTelegramTitle>@semantix_one</LandingFooterTelegramTitle>
                    </LandingFooterContactTelegramBlock>
                    <LandingFooterContactEmailBlock to="mailto:hello@semantix.one">
                    ...
                    <LandingFooterEmailTitle itemProp="email">hello@semantix.one</LandingFooterEmailTitle>
                    </LandingFooterContactEmailBlock>
                </LandingFooterContactsBlock>
            </LandingFooterBody>
        </LandingFooterBlock>
